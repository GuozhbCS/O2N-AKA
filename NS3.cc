...
uint32_t M1=64, M2=64, M3=64, M4=72;//, M5=64;//, M6=20;//, M7=40, M8=20;
...
int main (int argc, char *argv[])
{
 ...
 // cmd.AddValue ("M5", "Size of message 5 ", M5);
  //cmd.AddValue ("M6", "Size of message 6 ", M6);
 // cmd.AddValue ("M7", "Size of message 7 ", M7);
  //cmd.AddValue ("M8", "Size of message 8 ", M8);
